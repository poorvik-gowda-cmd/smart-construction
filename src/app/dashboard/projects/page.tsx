  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-extrabold text-white tracking-tight">{t('Projects Inventory')}</h1>
          <p className="text-slate-500 mt-1">{t('Manage and track all active and upcoming constructions.')}</p>
        </div>
      ...
      {filteredProjects.length === 0 && (
        <div className="py-20 text-center space-y-4">
          ...
          <p className="text-slate-500 font-medium">{t('No projects found matching your criteria.')}</p>
        </div>
      )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-3xl w-full max-w-md shadow-2xl animate-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-bold text-white">{t('New Project')}</h3>
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              <div>
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">{t('Project Name')}</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest text-emerald-400">{t('Budget (₹)')}</label>
