  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-extrabold text-white tracking-tight">Supplier Network</h1>
          <p className="text-slate-500 mt-1">Manage vendor relationships, purchase history, and material sourcing.</p>
        </div>
          ...
          <div key={supplier.id} className="bg-slate-900 border border-slate-800 hover:border-blue-900/50 rounded-3xl p-6 shadow-xl transition-all group hover:translate-y-[-2px] hover:shadow-2xl cursor-pointer">
            ...
            <div className="border-t border-white/5 pt-4 flex items-center justify-between">
              <div className="flex items-center space-x-2 text-xs font-medium text-slate-500">
                ...
                <span>Last PO: <span className="text-slate-300 font-bold">{supplier.lastOrderDate}</span></span>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-3xl w-full max-w-md shadow-2xl animate-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-bold text-white">Add Supplier</h3>
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              <div>
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Supplier Name</label>
              ...
              <div>
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Material Tags (Comma separated)</label>
