...
export default function Sidebar({ role, onLogout }: SidebarProps) {
  ...
  const navigation = [
    ...
    { name: 'Overview', href: '/dashboard', icon: LayoutDashboard, roles: ['admin', 'internal', 'client'] },
    { name: 'Projects', href: '/dashboard/projects', icon: BarChart3, roles: ['admin', 'internal'] },
    { name: 'Labor', href: '/dashboard/labor', icon: Users, roles: ['admin', 'internal'] },
    { name: 'Attendance', href: '/dashboard/attendance', icon: HardHat, roles: ['admin', 'internal'] },
    { name: 'Materials', href: '/dashboard/materials', icon: Package, roles: ['admin', 'internal'] },
    { name: 'Suppliers', href: '/dashboard/suppliers', icon: Truck, roles: ['admin', 'internal'] },
    { name: 'Expenses', href: '/dashboard/expenses', icon: CreditCard, roles: ['admin', 'internal'] },
    { name: 'Site Updates', href: '/dashboard/updates', icon: MapIcon, roles: ['admin', 'internal'] },
    { name: 'Documents', href: '/dashboard/documents', icon: Files, roles: ['admin', 'internal'] },
    { name: 'Safety & Issues', href: '/dashboard/safety', icon: AlertTriangle, roles: ['admin', 'internal'] },
    { name: 'Complaint Inbox', href: '/dashboard/admin/complaints', icon: MessageCircleWarning, roles: ['admin', 'internal'] },
    // Client portal items
